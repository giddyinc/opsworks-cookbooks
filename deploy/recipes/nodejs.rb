...
node[:deploy].each do |application, deploy|
  ...
  deploy.set[:purge_before_symlink] = %w{log tmp/pids public/system node_modules}
  deploy.set[:symlinks] = {"system" => "public/system", "pids" => "tmp/pids", "log" => "log", "node_modules" => "node_modules"}
  opsworks_deploy do
    deploy_data deploy
    app application
  end
